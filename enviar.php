...
// Mudar Aqui o e-mail
$email_envio = "formulario@valloura.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "Agrovalloura@1"; // Senha do e-mail

$site_name = "Valloura"; // Nome do Site
$site_url = "www.valloura.com.br/2021"; // URL do Site

$host_smtp = "br606.hostgator.com.br"; // HOST SMTP Ex: smtp.domain.com.br
